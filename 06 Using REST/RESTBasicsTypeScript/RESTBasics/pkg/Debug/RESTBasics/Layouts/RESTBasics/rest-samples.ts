...
function createList() {
    ...
    const url = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists";
    ...
    $.ajax({
        ...
        data: paramList,
        headers: headers,
        success: data => { console.log("list created ", data) },
        error: err => { console.log(err) }
    });
};
...
function deleteList() {
    ...
    $.ajax({
        ...
        success: () => { console.log("list deleted") },
        error: err => { console.log(err) }
    });
}
...
function createSite() {
    ...
    $.ajax({
        ...
        success: () => { console.log("Site created") },
        error: err => { console.log(err) }
    });
}