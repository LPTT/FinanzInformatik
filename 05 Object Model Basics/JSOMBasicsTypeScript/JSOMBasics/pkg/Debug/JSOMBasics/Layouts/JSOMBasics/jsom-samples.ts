...
function createWebsite() {
    ...
    var webCreationInfo: SP.WebCreationInformation = new SP.WebCreationInformation();
...
function addFieldToList() {
    ...
    var fld: SP.Field = list.get_fields().addFieldAsXml('<Field DisplayName=\'MyField\' Type=\'Number\' />', true, SP.AddFieldOptions.defaultValue);
...
function deleteList() {
    ...
    var clientContext: SP.ClientContext = SP.ClientContext.get_current();
    var web: SP.Web = clientContext.get_web();
    var list: SP.List = web.get_lists().getByTitle("News");
    list.deleteObject();
...
function createListItem() {
    ...
    var list: SP.List = clientContext.get_web().get_lists().getByTitle('News');
